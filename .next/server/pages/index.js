...
const getStaticProps = async () => {
  const client = await external_mongodb_["MongoClient"].connect(`mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@${process.env.DB_HOST}/meetups?retryWrites=true&w=majority`);
  const db = client.db();
